// js/modules/media.js - Obsługa multimediów w postach
...
const Media = {
            ...
            imageUpload.addEventListener('change', (e) => {
                ...
                if (file) {
                    ...
                    if (!allowedTypes.includes(file.type)) {
                        showNotification('Nieprawidłowy typ pliku. Wybierz JPG, PNG, GIF lub WebP', 'error');
                        return;
                    }
                    
                    // Walidacja rozmiaru (5MB)
                    if (file.size > 5 * 1024 * 1024) {
                        showNotification('Plik jest za duży. Maksymalny rozmiar: 5MB', 'error');
                        return;
                    }
    ...
    setupEmojiButton() {
        ...
        if (emojiBtn && emojiPicker) {
            emojiBtn.addEventListener('click', (e) => {
                ...
                if (!isVisible) {
                    // Pozycjonowanie relative do przycisku
    ...
    notifyImageChange() {
        // Wywołaj globalną funkcję aktualizacji przycisku jeśli istnieje
        if (typeof window.updatePostSubmitButton === 'function') {
