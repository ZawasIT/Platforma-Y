...
<aside class="sidebar-left">
    <div class="sidebar-content">
        ...
        <nav class="main-nav">
            ...
            <a href="#" class="nav-item" id="search-link">
                <svg viewBox="0 0 24 24" class="nav-icon">
            ...
            <a href="#" class="nav-item" id="notifications-link">
                <svg viewBox="0 0 24 24" class="nav-icon">
            ...
            <a href="messages.php" class="nav-item <?php echo ($activePage == 'messages.php') ? 'active' : ''; ?>">
                <svg viewBox="0 0 24 24" class="nav-icon">
                ...
                <span class="notification-badge" id="messages-count" style="display: none;"></span>
            </a>
        ...
        <div class="user-info">
            <a href="profile.php?user=<?php echo htmlspecialchars($currentUser['username']); ?>" style="display: flex; align-items: center; gap: 12px; text-decoration: none; color: inherit; flex: 1;">
            ...
            <a href="includes/logout.php" class="logout-link" title="Wyloguj">
